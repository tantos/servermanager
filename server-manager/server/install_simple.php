...
try {
    ...
    if ($mysqli->query($sql)) {
        ...
        throw new Exception("Error creating servers table: " . $mysqli->error);
    }
    ...
    if ($mysqli->query($sql)) {
        ...
        throw new Exception("Error creating server keys table: " . $mysqli->error);
    }
    ...
    if ($mysqli->query($sql)) {
        ...
        throw new Exception("Error creating server sites table: " . $mysqli->error);
    }
    ...
    if ($mysqli->query($sql)) {
        ...
        throw new Exception("Error creating command history table: " . $mysqli->error);
    }
    ...
    if ($stmt->execute()) {
        ...
        throw new Exception("Error creating regular user: " . $stmt->error);
    }
